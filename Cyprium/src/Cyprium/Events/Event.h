...
namespace Cyprium
{
	...
	// Better approach: Buffer events in an event bus and process them during the event part of update

	enum class EventType
	{
		None = 0,
		WindowClose, WindowResize, WindowFocus, WindowLostFocus, WindowLostFocus, WindowMoved,
